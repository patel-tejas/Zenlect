            ...
            <div className='flex items-center justify-center'>
                <div className='grid grid-cols-1 text-left md:grid-cols-2 gap-5 md:px-20 md:py-20 w-full justify-items-center md:justify-items-start'>
                    ...
                    <div className='flex flex-col gap-3 text-center md:text-left'>
                        ...
                        <a className='hover:text-blue-500 text-sm lg:text-[15px]' href={"/privacy-policy"}>Privacy Policy</a>
                        <a className='hover:text-blue-500 text-sm lg:text-[15px]' href={"/usage-policy"}>Terms of Use</a>
                        <a className='hover:text-blue-500 text-sm lg:text-[15px]' href={"/identity"}>Our Identity</a>
                        
                    </div>
                    <div className='flex flex-col gap-3 text-center md:text-left'>
                        <h2 className='text-xl font-bold py-2'>Contact</h2>
                        <a href={"/mailto:support@zenlect.com"} className='text-sm lg:text-[15px] hover:text-blue-500 text-gray-300'>support@zenlect.com</a>
