...
export function FeaturesSectionMain() {
    const features = [
        ...
        },
        {
            ...
            description:
                "Pinpoint any image's exact location with ZENLECT's state-of-the-art AI, designed for unparalleled accuracy.",
        ...
        },
        {
            ...
            description:
                "Explore our innovative AI capabilities through in-depth product demos on YouTube.",
            skeleton: <SkeletonThree />,
            className:
                "col-span-1 lg:col-span-3 lg:border-r  border-neutral-800",
        },
        {
            title: "Predicts any image's location from globe",
            description:
            ...
            <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
                ...
                <div className="px-8">
                    <h4 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-white">
                        Revolutionizing Geolocation and Legal Practices with AI
                    </h4>

                    <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal">
                        At ZENLECT, we specialize in cutting-edge AI technologies that transform industries through pinpoint precision and enhanced legal capabilities.
                    </p>
                </div>
