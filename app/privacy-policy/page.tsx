    ...
    <div className='h-full py-10 font-poppins'>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <ul className="list-disc list-inside mb-8">
          ...
          <li><strong>Website</strong> refers to Zenlect, accessible from <Link href="https://zenlect.com" className="text-blue-500 underline">zenlect.com</Link>.</li>
        ...
        <ul className="list-disc list-inside mb-4">
          <li>By email:<Link className='text-blue-500' href="mailto:support@zenlect.ai"> support@zenlect.ai</Link></li>
        </ul>
