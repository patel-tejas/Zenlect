...
const page = () => {
  return (
    <div className='font-sans min-h-screen flex flex-col gap-5 px-5 md:px-20 mt-10'>
        <h1 className='font-semibold overflow-hidden text-[10vw] sm:text-[4vw] whitespace-nowrap text-center'>
          Our Identity
        </h1>
        <div className='flex flex-col gap-3 text-xl  mt-5 text-center'>
